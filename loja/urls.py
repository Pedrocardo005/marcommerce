...
urlpatterns = [
    ...
    path(
        "anuncios/categoria/<int:pk>",
        GetAllAnuncioCategoria.as_view(),
    ...
    path(
        ...
        name="loja.alterar-senha",
    ),
    path(
        "usuarios/resetar_senha",
        PasswordResetRequestAPI.as_view(),
        name="loja.resetar-senha",
    ),
    path(
        "usuarios/confirm_resetar_senha",
